...
ProductDetailsDataRow $ProductDetailsDataRowFromJson(
  ...
  final dynamic youtube = json['youtube'];
  if (youtube != null) {
...
ProductDetailsDataRowAttributesChilds $ProductDetailsDataRowAttributesChildsFromJson(
  ...
  final dynamic oldPrice = json['oldPrice'];
  if (oldPrice != null) {
  ...
  final dynamic qty = json['qty'];
  if (qty != null) {
    productDetailsDataRowAttributesChilds.qty = qty;
  }
  final dynamic minQtyPerOrder = json['minQtyPerOrder'];
  if (minQtyPerOrder != null) {
    productDetailsDataRowAttributesChilds.minQtyPerOrder = minQtyPerOrder;
  }
  final dynamic availableQty = json['availableQty'];
  if (availableQty != null) {
...
ProductDetailsDataRowAttributesReadOnlyChilds $ProductDetailsDataRowAttributesReadOnlyChildsFromJson(
  ...
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    productDetailsDataRowAttributesReadOnlyChilds.id = id;
  }
  final String? title = jsonConvert.convert<String>(json['title']);
  if (title != null) {
  ...
  final dynamic oldPrice = json['oldPrice'];
  if (oldPrice != null) {
    productDetailsDataRowAttributesReadOnlyChilds.oldPrice = oldPrice;
  }
  final dynamic price = json['price'];
  if (price != null) {
    productDetailsDataRowAttributesReadOnlyChilds.price = price;
  }
  final dynamic qty = json['qty'];
  if (qty != null) {
    productDetailsDataRowAttributesReadOnlyChilds.qty = qty;
  }
  final dynamic minQtyPerOrder = json['minQtyPerOrder'];
  if (minQtyPerOrder != null) {
    productDetailsDataRowAttributesReadOnlyChilds.minQtyPerOrder =
        minQtyPerOrder;
  }
  final dynamic availableQty = json['availableQty'];
  if (availableQty != null) {
    productDetailsDataRowAttributesReadOnlyChilds.availableQty = availableQty;
  }
  final bool? outOfStock = jsonConvert.convert<bool>(json['outOfStock']);
  if (outOfStock != null) {
    productDetailsDataRowAttributesReadOnlyChilds.outOfStock = outOfStock;
  }
